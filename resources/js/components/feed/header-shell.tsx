...
export default function FeedHeaderShell({ user }: FeedHeaderShellProps) {
    ...
    return (
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
                <div className="_custom_container container">
                    ...
                    >
                        <div className="_header_form ms-auto">
                            <form className="_header_form_grp">
                                ...
                                <input
                                    className="form-control _inpt1 me-2"
                                    type="search"
                        ...
                        <ul className="navbar-nav mb-lg-0 _header_nav_list _mar_r8 ms-auto mb-2">
